...
def btls_client_cert(client_log_file, curve, ciphersuites, psk=False):
	for ciphersuite in ciphersuites:
		if psk:
			cmd = ('s_client -connect 127.0.0.1:8443 -no-CAfile -verify 1 -state -cipher {} -tls1_2 -psk 123456 2>{}'
					.format(ciphersuite, client_log_file))
		else:
			cmd = ('s_client -connect 127.0.0.1:8443 -no-CAfile -verify 1 -state -cipher {} -tls1_2 2>{}'
					.format(ciphersuite, client_log_file))
